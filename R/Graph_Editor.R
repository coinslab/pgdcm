...
edgeadd <- function(theigraph,fromnodechoice, tonodechoice,colornickname){
  colorchoice <- switch(colornickname, "r"="red","b"="blue","g"="green","p"="purple","o"="orange","black")
...
LayoutChange <- function(theigraph,layoutchoicestring){
  layoutchoice = switch(  
    layoutchoicestring,  
    "st"= {plot(theigraph, layout = layout_as_star, main = "Competency and Evidence Graph")},
    "tr" = {plot(theigraph, layout = layout_as_tree, main = "Competency and Evidence Graph")},
    "ci" = {plot(theigraph, layout = layout_in_circle, main = "Competency and Evidence Graph")},
    "ni" = {plot(theigraph, layout = layout_nicely, main = "Competency and Evidence Graph")},
    "sp" = {plot(theigraph, layout = layout_on_sphere, main = "Competency and Evidence Graph")},
    "dh" = {plot(theigraph, layout = layout_with_dh, main = "Competency and Evidence Graph")},
    "fr" = {plot(theigraph, layout = layout_with_fr, main = "Competency and Evidence Graph")},
    "gm" = {plot(theigraph, layout = layout_with_gem, main = "Competency and Evidence Graph")},
    "kk" = {plot(theigraph, layout = layout_with_kk, main = "Competency and Evidence Graph")},
    "lg" = {plot(theigraph, layout = layout_with_lgl, main = "Competency and Evidence Graph")},
    "md" = {plot(theigraph, layout = layout_with_mds, main = "Competency and Evidence Graph")},
    "sg" = {plot(theigraph, layout = layout_with_sugiyama, main = "Competency and Evidence Graph")},
    "bp" = {plot(theigraph, layout = layout_as_bipartite, main = "Competency and Evidence Graph")},
  )
}
  ...
  while (quitloop == 0)
  {
    ...
    result = switch(
      userchoice,
          ...
          "v" = {
                if(is.null(theigraph)) { print("Read graph first."); next }
