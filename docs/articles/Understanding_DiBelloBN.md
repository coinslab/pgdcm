...
network model defined in the file `DiBelloBN.R`. This one piece of
...
capability of `DiBelloBN`. The network has **three layers**:
...
The following table summarizes how the same `DiBelloBN` code adapts to
