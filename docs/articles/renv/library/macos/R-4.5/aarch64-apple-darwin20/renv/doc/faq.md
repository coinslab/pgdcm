...
`dependencies()` uses static analysis and does not understand all of the
different ways in which a package might be used in a project. See the
...
[`?renv::load`](https://rstudio.github.io/renv/reference/load.html) more
details.
