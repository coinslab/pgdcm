...
- `skill_profiles`: Generated by
  [`generate_summary_tables()`](generate_summary_tables.md); An I x K
  matrix of posterior mean mastery for each student.

- `item_parameters`: Generated by
  [`generate_summary_tables()`](generate_summary_tables.md); A clean
  table of difficulty and discrimination parameters per item.

- `group_patterns`: Generated by
  [`generate_summary_tables()`](generate_summary_tables.md); A list
  organizing participants into latent classes based on 0.5 mastery
  thresholds.
